---
title: "Historical Voting Record"
format: 
  html:
    toc: true
    toc-location: left
...
load("alder_data_processed_old.RData")

```

**This is the historical voting record**

Updated on `r format(Sys.Date(), "%B %d, %Y")`.

## 2023-2025 YIMBY Scores
...
#| tbl-cap: Percentage of contested votes by all alders that were pro-housing (YIMBY).
#| echo: false
#| warning: false
#| message: false
...
## All Housing Votes, 2023-2025 Term
...
kable(YIMBY.vote.list.2024, "html", escape = FALSE) %>%
  ...
  row_spec(0, bold = TRUE, color = "black", background = "#66cbff", extra_css = "padding: 7px 6px;") %>%
  row_spec(1:nrow(YIMBY.vote.list.2024), extra_css = "padding: 4px 6px; line-height: 1.1;") %>%
  column_spec(1:5, bold = FALSE) %>%
  column_spec(6, color = ifelse(((YIMBY.vote.list$YIMBY & YIMBY.vote.list$`1` == "Y") |
                                 (!YIMBY.vote.list$YIMBY & YIMBY.vote.list$`1` == "N"))
                               | is.na(YIMBY.vote.list$`1`), "blue", "red")) %>%
...
kable(YIMBY.vote.list.2023, "html", escape = FALSE) %>%
  ...
  row_spec(0, bold = TRUE, color = "black", background = "#66cbff", extra_css = "padding: 7px 6px;") %>%
  row_spec(1:nrow(YIMBY.vote.list.2023), extra_css = "padding: 4px 6px; line-height: 1.1;") %>%
  column_spec(1:5, bold = FALSE) %>%
  column_spec(6, color = ifelse(((YIMBY.vote.list$YIMBY & YIMBY.vote.list$`1` == "Y") |
                                 (!YIMBY.vote.list$YIMBY & YIMBY.vote.list$`1` == "N"))
                               | is.na(YIMBY.vote.list$`1`), "blue", "red")) %>%
