...
#| tbl-cap: Percentage of votes by active alders that were pro-housing (YIMBY).
#| echo: false
#| warning: false
#| message: false
...
```{r}
#| label: tbl-all-votes
#| tbl-cap: Votes of active alders, listed by their district. YIMBY votes in blue, anti-YIMBY votes in red.
#| echo: false
#| warning: false
#| message: false
